...
{
    private static string ServiceUrl = "https://localhost:7257/";
    ...
    private static async Task DoTheCodeFlowAsync()
    {
        ...
        var bld = PublicClientApplicationBuilder
            .Create("6223e72d-7209-4ab2-8fcd-dc5372137db3")
        ...
        var token = await app.AcquireTokenInteractive(
            new string[] { "api://6223e72d-7209-4ab2-8fcd-dc5372137db3/Access" })
            .ExecuteAsync();
