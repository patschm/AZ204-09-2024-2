...
class Program
{
    private const string connectionString = "DefaultEndpointsProtocol=https;AccountName=psstoor;AccountKey=TIFOChhrhC8pVBOosOpxVVZIiIVmVNZF0acUwRVHpOF54qeLYOr/2+kDNGixxrV+WM/DCzrzEr7I+AStL5DaLA==;EndpointSuffix=core.windows.net";
