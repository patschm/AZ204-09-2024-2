...
namespace KeyVault
{
    class Program
    {
        ...
        static string kvUri = "https://ps-sleutelss.vault.azure.net/";
        ...
        private static async Task ReadAppConfigurationAsync()
        {
           ...
           // builder.AddJsonFile("appsettings.json");
            builder.AddAzureAppConfiguration(opts =>
            {
                ...
                opts.Connect("Endpoint=https://ps-config.azconfig.io;Id=WcJD;Secret=84WKHUjmQu6w1j0AfiOsyUotMdo7JNc2AERiHCEn4sKbrD2XPZoTJQQJ99AJAC5RqLJJs58ZAAACAZAC7ydC")
                    .Select(KeyFilter.Any, "Production")
                     .TrimKeyPrefix("KeyVault:Program:");
